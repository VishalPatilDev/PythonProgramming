...
class Ui_C2W_PythonInfoDialog(object):
    ...
    def setupUi(self, Widget):
        ...
        pixmap1 = QtGui.QPixmap('C:\\Users\\91866\\Python_Projects\\Day2\\PYTHON-LIBRARY\\assets\\images\\image (1).jpeg')
        ...
        self.c2w_pdf_viewer = PDFViewer('C:\\Users\\91866\\Python_Projects\\Day2\\PYTHON-LIBRARY\\assets\\pdf\\demo (5).pdf')
        layout = QtWidgets.QVBoxLayout(self.c2w_tab)
        layout.addWidget(self.c2w_pdf_viewer)

        # Add PDFViewer to the History tab
        self.c2w_pdf_viewer = PDFViewer('C:\\Users\\91866\\Python_Projects\\Day2\\PYTHON-LIBRARY\\assets\\pdf\\demo (6).pdf')
        layout = QtWidgets.QVBoxLayout(self.c2w_tab_2)
        layout.addWidget(self.c2w_pdf_viewer)

        # Add PDFViewer to the Index Tab
        self.c2w_pdf_viewer = PDFViewer('C:\\Users\\91866\\Python_Projects\\Day2\\PYTHON-LIBRARY\\assets\\pdf\\demo1.pdf')

...
class C2W_Home(object):
    ...
    def setupUi(self, Widget):
        ...
        # Load an image of the python logo using QPixmap
        pixmap = QtGui.QPixmap('C:\\Users\\91866\\Python_Projects\\Day2\\PYTHON-LIBRARY\\assets\\images\\image (1).jpeg')
        ...
        icon_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'assets', 'images', 'image (2).jpg'))
